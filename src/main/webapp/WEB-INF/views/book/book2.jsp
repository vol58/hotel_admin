...
<section>
	<form method="get" action="book3" onsubmit="return pay_check();">
		...
		<table align="center">
			...
			<tr>
				<td colspan="2">${rvo.name}호<br> ${bvo.checkin} ~
					${bvo.checkout} <br> <span id="num1">${bvo.checkout-bvo.checkin}</span>박<br>
					${bvo.person} 명
				</td>
			</tr>
			<tr>
				<td>조식</td>
				<td><select name="breakfast" id="breakfast"
					onchange="breakfast_price()">
			...
			<tr>
				...
				<td id="room_price" align="right">
					${rvo.price*(bvo.checkout-bvo.checkin)} 원</td>
			</tr>
			<tr>
				<td>조식 금액</td>
			...
			<tr>
				...
				<input type="radio" name="pay_method" value="onsite" onclick="pay_state(1)"> 현장결제
					&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <input id="payment"
