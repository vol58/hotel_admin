...
<style>
 ...
 function init()
 {
	 ...
	 var gu2=gu.charAt(1);
	  ...
	  document.ht.gubun_1[gu1].checked=true;
 ...
 <section>
  ...
  <div align="right" style="color:red;font-size:10px;" > ** 모든 항목 선택 및 기재 필수 **</div>  
    ...
    <tr>
      ...
      <td>
        <input id="qna_title" type="text" name="title"  value="${qvo.title}" placeholder="제 목" size="20"> 
      </td>
    </tr>
    <tr>
      <td align="center"> 내 용 </td>
      <td><textarea cols="80" rows="20" name="content" placeholder="문의 사항을 기재해주세요.">${qvo.content}</textarea> </td>
    </tr>
    <tr>
      <td colspan="2" align="center" height="100">
        <input type="button" onclick="check_emp()" value="수정">
      </td>
    </tr>
  </table>
  ...
  <div id="msg_b">  
   <div id="check_msg"> 
      <h3> 123님 <%-- ${name}님 --%>  <!--  나중에 session값  -->
       <br>아래내용으로 문의를  변경 하시겠습니까? :)
      </h3>
